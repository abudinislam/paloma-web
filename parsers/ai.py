...
CLAUDE_PROMPT = """Определи тип документа. Если это НЕ накладная, счёт, счёт-фактура, товарный чек или акт — верни ровно:
{"not_invoice":true}

Если это торговый документ — извлеки все товарные позиции.
Документ может быть повёрнут на 90°, 180° или 270° — читай текст в любой ориентации.
